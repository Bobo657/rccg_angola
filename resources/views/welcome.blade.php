            ...
            <ul>
                ...
                <li data-index="rs-1" data-transition="slidingoverlayhorizontal" data-slotamount="default" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="/images/bg/bg4.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide 1" data-description="">
                    ...
                    <div class="tp-caption tp-resizeme text-uppercase  bg-dark-transparent text-white font-raleway pl-30 pr-30"
                      ...
                      style="z-index: 7; white-space: nowrap; font-weight:400; border-radius: 30px;">The Redeemed Christian Church of God
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme text-uppercase bg-theme-colored-transparent text-white font-raleway pl-30 pr-30"
                      ...
                      data-splitout="none" 
                      data-responsive_offset="on"
                      style="z-index: 7; white-space: nowrap; font-weight:700; border-radius: 30px;">Resurrection Ground Parish
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme text-white text-center" 
                      ...
                      data-splitout="none" 
                      data-responsive_offset="on"
                      style="z-index: 5; white-space: nowrap; letter-spacing:0px; font-weight:400;">It's a great privilege to have you visiting and hoped to have you as part of our wonderful family. <br>Join this great family as we together make the difference the world is looking for.
                    </div>
                </li>
    ...
    <section>
      <div class="container pt-0">
        <div class="section-content">
          <div class="row">
            <div class="col-md-4">
              <div class="icon-box bg-lighter text-center p-30 mt-sm-0 border-1px" data-margin-top="-90px" style="margin-top: -90px;">
                <a class="icon icon-lg bg-theme-colored icon-circled icon-border-effect effect-circled text-white" href="#">
                  <i class="flaticon-charity-make-a-donation"></i>
                </a>
                <h4 class="icon-box-title text-uppercase letter-space-3"><a class="text-theme-colored" href="#">CORE OBJECTIVE</a></h4>
                <p class="">Reach Angolans, equip them with the undiluted Truth of God's Word and the Holy Spirit so that burning with passion and zeal for the Lord's Kingdom, they will eclipse the territory with the principles and glory of God's kingdom..</p>
            ...
            <div class="col-md-4">
              <div class="icon-box bg-lighter text-center p-30 mt-sm-0 border-1px" data-margin-top="-90px" style="margin-top: -90px;">
                ...
                <h4 class="icon-box-title text-uppercase letter-space-3"><a class="text-theme-colored" href="#">ABOUT US</a></h4>
                <p class="">RCCG Resurrection Ground Parish was founded on the 6th of October, 2013 and was pioneered by Pastor Joseph Ugochukwu Okenwa who is also the Country Coordinator of The Redeemed Christian Church of God Angola</p>
                <a href="/about" class="btn btn-theme-colored  text-uppercase mt-10">More info</a>
              </div>
            </div>
            <div class="col-md-4">
              <div class="icon-box bg-lighter text-center p-30 mt-sm-0 border-1px" data-margin-top="-90px" style="margin-top: -90px;">
                ...
                <h4 class="icon-box-title text-uppercase letter-space-3"><a class="text-theme-colored" href="#">OUR BELIEF</a></h4>
                <p class="">We believe that the entire Scripture, both Old and New Testament are written by the inspiration of the Holy Spirit – II Tim. 3:16-17. All the Christian teachings and the Christian attitude of the Children of God.</p>
                <a href="/about" class="btn btn-theme-colored  text-uppercase mt-10">More info</a>
              </div>
            </div>
          </div>
    ...
    <section>
      <div class="container pt-0 pb-60 mt-0">
        <div class="section-content">
          <div class="row">
            <div class="col-md-7">
              <h2 class="text-uppercase mt-0">Mission & Vision of <span class="text-theme-colored"> RCCG</span></h2>
              <h4 class="text-gray-dimgray font-weight-400"><em>You Can Talk to Someone no matter what the challenge is.</em></h4> 
              <ul class="list check">
        ...
        <div class="section-content">
          <div class="row">
            ...
            <div class="col-md-7">
              ...
              <h4 class="text-gray-dimgray font-weight-400"><em>Your generosity helps to build the church and make a positive impact in the lives of individuals.</em></h4>
              <p class="mb-20">The generosity and commitment of God's people contribute immensely to the church achievement and its strength. This is evident through the countless volunteer effort by those serving in church services and through those who financially support the church and its plans.</p>

              <p class="mb-20">The church believe in the Biblical principle of tithing in Malachi 3:10 (NLT). God is depending on you to contribute to meeting the needs of His church and His people through Tithes, offering and free will donations from a godly heart. If you would like to take a step of faith to give to the church, there are several options.</p>
