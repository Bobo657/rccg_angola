...
<div id="wrapper">
        ...
        <div class="section-content">
          <div class="row">
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-160px" data-wow-duration="1s" data-wow-delay="0.1s">
              <img class="img-fullwidth" src="/images/services/b1.jpg" alt="">
              <div class="bg-silver-light border-1px p-20 pt-0 pb-30 mb-sm-180">
                  <h4 class="text-uppercase letter-space-1 mt-10">Help The<span class="text-theme-colored"> Poor</span></h4>
            ...
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-40 wow fadeInUp" data-margin-top="-160px" data-wow-duration="1s" data-wow-delay="0.1s">
              <img class="img-fullwidth" src="/images/services/b2.jpg" alt="">
              <div class="bg-silver-light border-1px p-20 pt-0 pb-30 mb-sm-180">
                  <h4 class="text-uppercase letter-space-1 mt-10">Become a<span class="text-theme-colored">  Volunteer</span></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero omnis unde nesciunt?</p>
                <a href="#" class="btn btn-sm btn-theme-colored">Read more</a>
              </div>
            </div>
            <div class="col-sm-6 col-md-4 maxwidth500 mb-sm-0 wow fadeInUp" data-margin-top="-160px" data-wow-duration="1s" data-wow-delay="0.1s">
              <img class="img-fullwidth" src="/images/services/b3.jpg" alt="">
              <div class="bg-silver-light border-1px p-20 pt-0 pb-30">
                  <h4 class="text-uppercase letter-space-1 mt-10">Education For<span class="text-theme-colored"> Poor</span></h4>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero omnis unde nesciunt?</p>
                <a href="#" class="btn btn-sm btn-theme-colored">Read more</a>
              </div>
            </div>
    ...
    <section>
      <div class="container pt-0 pb-60 mt-0">
        <div class="section-content">
          <div class="row">
            <div class="col-md-7">
              <h2 class="text-uppercase mt-0">Welcome To<span class="text-theme-colored"> eCharity</span></h2>
              ...
              <p>Sit amet consectetur adipisicing elit. Aliquid iste iusto reiciendis praesentium dolorem doloribus nisi architecto voluptatibus explicabo, possimus ullam quae illum maiores.</p>
            ...
            <div class="col-md-5">
             ...
             <div class="row">
               <div class="col-md-6 pr-5 pr-sm-15 mb-sm-10">
                 <img alt="" src="/images/about/c2.jpg" class="img-fullwidth">
               </div>
               <div class="col-md-6 pl-5 pl-sm-15">
                 <img alt="" src="/images/about/c3.jpg" class="img-fullwidth">
               </div>
             </div>
            </div>
          </div>
  ...
  <!-- Footer -->
  <footer id="footer" class="footer footer-white" data-bg-color="#fff">
